        ...
        <>
            <form onSubmit={(e) => { handleSubmit(e) }} style={{margin:"auto",width:"500px"}} className="border p-4 text-light">
                <div className="mb-3">
                    ...
                    />
                    <small className="text-light">{errors.nameError}</small>
                </div>
                <div className="mb-3">
                    ...
                    />
                    <small className="text-light">{errors.emailError}</small>
                </div>
                <div className="mb-3">
                    <label htmlFor="formGroupExampleInput2" className="form-label">
                        User Name
                    ...
                    />
                    <small className="text-light">{errors.userNameError}</small>
                </div>
                <div className="mb-3">
                    <label htmlFor="formGroupExampleInput2" className="form-label">
                        Password
                    ...
                    />
                    <small className="text-light">{errors.passwordError}</small>
                </div>
                <div className="mb-3">
                    <label htmlFor="formGroupExampleInput2" className="form-label">
                        Confirm Password
                    ...
                    />
                    <small className="text-light">{errors.confirmPasswordError}</small>
                </div>
